...
import threading
import subprocess
from art import *                       # Modules For Some ASCII Art
...
# responsible for handling command-line arguments and calling the rest of functions
def usage():
    tprint("NETCAT", "rand")
    print("")
    print("")
    ...
    print("""-e --execute=fle_to_run    - execute the given file upon
...
# this is the main function of netcat project
def main():
    global listen
    global port
    global execute
    ...
    if len(upload_destination):
        ...
        while True:
            ...
            try:
                ...
                client_socket.send(b"Succesfully saved file to {}\r\n".format(upload_destination))
            except:
